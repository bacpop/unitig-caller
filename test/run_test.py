...
subprocess.run("unitig-caller --call --refs refs.txt --output test_call --pyseer --rtab", shell=True, check=True)
...
subprocess.run("unitig-caller --query --refs refs.txt --unitigs test_unitigs.fasta --output test_query --pyseer --rtab", shell=True, check=True) # checks if can be run
