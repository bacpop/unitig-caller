...
subprocess.run("python test-calls.py --method pyseer --test test_query_pyseer.txt --expected bifrost_result.pyseer", shell=True, check=True) # checks results match
