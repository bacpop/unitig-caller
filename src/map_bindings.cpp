...
PYBIND11_MODULE(unitig_query, m)
{
  ...
  m.def("call_unitigs_existing", &py_uc_exists, "Call/queries unitigs and their colours in an existing Bifrost graph",
          py::arg("graphfile"),
          py::arg("coloursfile"),
          py::arg("call"),
          py::arg("query_file"),
  ...
  m.def("call_unitigs_build", &py_uc_build, "Builds and then calls/queries unitigs in Bifrost graph",
          py::arg("infile1"),
          py::arg("kmer"),
          py::arg("call"),
          py::arg("query_file"),
